...
int main(int argc, char **argv)
{
    ...
    while (ros::ok()) {
        ...
        cout << "Press enter when at the elevator" << endl;
        cin.get();
        sleepok(2,n);
        ...
        cout << "Press enter when inside the elevator" << endl;
        cin.get();
        sleepok(2,n);
        ...
        cout << "Press enter when outside the elevator" << endl;
        cin.get();
        sleepok(2,n);
        
        cout << "Press enter when at the coffeeshop" << endl;
        cin.get();
        sleepok(2,n);
        ...
        cout << "Press enter when back to user" << endl;
        cin.get();
        sleepok(2,n);
